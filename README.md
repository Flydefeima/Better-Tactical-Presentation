...
- **Third-Person Lean Animation**: Optional third-person lean animation with smooth fade-in (requires [PlayerAnimator](https://github.com/KosmX/minecraftPlayerAnimator).
...
- playeranimator (optional): Required for third-person lean animation
